...
[📂 Ver arquivo no repositório — `concatena_strings.py`](.src/concatena_strings.py)
...
Use este repositório como um espaço para:

- Praticar lógica de programação em **Python**  
- Aprender a se comunicar melhor com o **ChatGPT** e o **GitHub Copilot**  
- Criar pequenas automações e testar soluções rápidas
